...
function PrivacyPolicy() {
  return (
    <div className={classes.container}>
      <h5 className={classes.heading}>Privacy policy:</h5>
      <p className={classes.desc}>
        <p className={classes.desc_heading}> Privacy Policy </p> This privacy
        policy sets out how Ralikson.com uses and protects any information that
        you give Ralikson.com when you use this website. Ralikson.com is
      ...
      <p className={classes.desc}>
        Ralikson.com may change this policy from time to time by updating this
        page. You should check this page from time to time to ensure that you
        are happy with any changes.
      </p>
      <p className={classes.desc}>What we collect</p>
      <p className={classes.desc}>We may collect the following information:</p>
      <ul className={classes.un_list}>
      ...
      <h3 className={classes.desc_heading}>Security</h3>
      <p className={classes.desc}>
      ...
      <p className={classes.desc}>How we use cookies </p>{" "}
      <p className={classes.desc}>
        ...
        being used. This helps us analyze data about web page traffic and
        ...
        which you do not. A cookie in no way gives us access to your computer or
        any information about you, other than the data you choose to share with
      ...
      <p className={classes.desc}> Controlling your personal information</p>{" "}
      <p className={classes.desc}>
      ...
      <ul className={classes.un_list}>
        ...
        <li>
          ...
          writing to or emailing us at [Ralikson.com Email]
        </li>
      </ul>
      <p className={classes.desc}>
